...
\033[1;33m
 _    _                                          __   __
| |  | |                                         \ \ / /
| |__| |   __ _  __  __  _ __     ___    ______   \ V / 
|  __  |  / _` | \ \/ / | '_ \   / _ \  |______|   > <  
| |  | | | (_| |  >  <  | | | | | (_) |           / . \ 
|_|  |_|  \__,_| /_/\_\ |_| |_|  \___/           /_/ \_\ \033[1;91mv1.0
...
===============================================\033[00m''')
  ...
  def not_ins(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mWe can't install Haxno-X.\033[1;m
...
\033[1;31m If you are installing this tool.
 that means you are agree with all terms.''')
  ...
  def ins_sc(self):
    self.tool_header()
    print ('''
\033[1;33m    [ + ] \033[1;32mHaxno-X installed successfully.
\033[1;33m    [ + ] \033[1;32mTo run Haxno-X.
\033[1;33m    [ + ] \033[1;32mType Haxno-X in your terminal.''')
    self.tool_footer()
  ...
  def update(self):
    self.tool_header()
    print ('''
\033[1;33m  [ 1 ] \033[1;32mUpdate your Haxno-X.
\033[1;33m  [ 0 ] \033[1;32mFor Back.\033[00m''')
  ...
  def updated(self):
    self.tool_header()
    print ('''
\033[1;33m      [ + ] \033[1;32mHaxno-X Updated Successfully.
...
\033[1;31m  [ + ]  \033[1;31mPlease try again after some time.\033[00m''')
  ...
  def update_error(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mWe can't Update Haxno-X.\033[1;m
\033[1;31m  [ + ]  \033[1;31mPlease try again after some time.\033[00m''')
    self.tool_footer()
  ...
  def about(self,total):
    self.tool_header()
    print (f'''
\033[1;33m       [+] Tool Name :- \033[1;32mHaxno-X
\033[1;33m       [+] Author :- \033[1;32mAakash Thakur
\033[1;33m       [+] Latest Update :- \033[1;32m23/3/2019.\033[1;m
\033[1;33m       [+] Tools :- \033[1;32mtotal {total} tools.\033[1;m

\033[1;33m [+] \033[1;32mHaxno-X is automatic tool installer.
...
\033[01;33m|  00) Back                                   |
 \033[01;36m=============================================\033[00m""")
  ...
  def updating(self):
    print ("""\033[01;33m =============================================
\033[01;32m|______________ Updating Haxno-X ______________|
 \033[01;33m=============================================\033[00m""")
...
\033[1;33m  [ 3 ] \033[1;32mUpdate Haxno-X.
...
\033[1;33m  [ x ] \033[1;32mFor Exit.''')
  ...
  def exit(self):
    self.tool_header()
    print ('''
\033[1;33m         [ + ] \033[1;32mThanks for using Haxno-X
