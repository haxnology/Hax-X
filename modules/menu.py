    ...
    while True:
      ...
      if cmd=="1":
        ...
        if system.connection:
          ...
          logo.updating()
          if system.sudo != None:
            if os.path.exists(system.home+"/Haxno-X"):
              pass
            else:
              os.system(system.sudo+" git clone https://github.com/Rajkumrdusad/Haxno-X.git "+system.home+"/Haxno-X")
            if os.path.exists(system.home+"/Haxno-X/install.aex"):
              os.system("cd "+system.home+"/Haxno-X && "+system.sudo+" sh install.aex")
            ...
            if os.path.exists(system.home+"/Haxno-X"):
              ...
              os.system("git clone https://github.com/Rajkumrdusad/Haxno-X.git "+system.home+"/Haxno-X")
            if os.path.exists(system.home+"/Haxno-X/install.aex"):
              os.system("cd "+system.home+"/Haxno-X && sh install.aex")
              if os.path.exists(system.bin+"/Haxno-X") and os.path.exists(system.conf_dir+"/Haxno-X"):
                os.system("clear")
                logo.updated()
                cmd=input("\033[1;36m ##> \033[00m")
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        logo.exit()
        break
      elif cmd=="rm -t" or cmd=="rm -T" or cmd=="uninstall Haxno-X" or cmd=="unistall Haxno-X":
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/Haxno-X")
          os.system(system.sudo+" rm -rf "+system.bin+"/haxnox")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/Haxno-X")
        else:
          os.system("rm -rf "+system.bin+"/Haxno-X")
          os.system("rm -rf "+system.bin+"/haxnox")
          os.system("rm -rf "+system.conf_dir+"/Haxno-X")
        os.system("clear")
        logo.exit()
        break
      else:
...
class tools:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/Haxno-X/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/Haxno-X/core/cat.json") as cat_file:
